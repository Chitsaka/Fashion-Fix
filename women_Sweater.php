...
<head>
	...
	<title>Fashion Fix | Women | Sweater</title>
</head>
<body>
...
$sql = 'SELECT * FROM product_details WHERE category = "sweater" AND gender ="Women"';
	...
	if ( $rows > 0 ) {
		...
		while ( $women_sweater = mysqli_fetch_assoc( $results ) ) {
				...
				<div class="card-body">
					...
					<p class="card-text">Ksh. ' . $women_sweater['price'] . '/=</p>
