...
<head>
	...
	<title>Fashion Fix | Women | Swimsuits</title>
</head>
<body>
<?php
require 'header.php';
...
$sql = 'SELECT * FROM product_details_men WHERE category = "swimsuits" AND gender ="Women"';
	...
	if ( $rows > 0 ) {
		...
		while ( $women_swimsuit = mysqli_fetch_assoc( $results ) ) {
				...
				<div class="card-body">
				  ...
				  <p class="card-text">Ksh. ' . $women_swimsuit['price'] . '/=</p>
