...
<head>
	...
	<title>Fashion Fix | Women | Dresses</title>
</head>
<body>
<?php
require 'header.php';
...
$sql = 'SELECT * FROM product_details WHERE category = "dresses" AND gender ="Women"';
	...
	if ( $rows > 0 ) {
		...
		while ( $women_dresses = mysqli_fetch_assoc( $results ) ) {
				...
				<div class="card-body">
				  ...
				  <p class="card-text">Ksh. ' . $women_dresses['price'] . '/=</p>
